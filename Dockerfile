...
ARG NEXT_PUBLIC_QUEUE_STRATEGY=""
ARG NEXT_PUBLIC_UPGRADE_ACTIONS_ENABLED=""
ARG NEXT_PUBLIC_UMES_DEVTOOLS=""
ARG NEXT_PUBLIC_OM_EXAMPLE_CHECKOUT_TEST_INJECTIONS_ENABLED=""
ENV NEXT_PUBLIC_APP_URL=${NEXT_PUBLIC_APP_URL} \
    NEXT_PUBLIC_QUEUE_STRATEGY=${NEXT_PUBLIC_QUEUE_STRATEGY} \
    NEXT_PUBLIC_UPGRADE_ACTIONS_ENABLED=${NEXT_PUBLIC_UPGRADE_ACTIONS_ENABLED} \
    NEXT_PUBLIC_UMES_DEVTOOLS=${NEXT_PUBLIC_UMES_DEVTOOLS} \
    NEXT_PUBLIC_OM_EXAMPLE_CHECKOUT_TEST_INJECTIONS_ENABLED=${NEXT_PUBLIC_OM_EXAMPLE_CHECKOUT_TEST_INJECTIONS_ENABLED}
